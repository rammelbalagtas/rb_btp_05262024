...
define view entity ZDT187v_XX_Flight_Cube
  as select from /DMO/I_Flight
  association [0..1] to ZDT187v_XX_Airline_Dim    as _Airline     on  _Airline.CarrierId       = $projection.AirlineID
  association [0..1] to ZDT187v_XX_Connection_Dim as _Connection  on  _Connection.CarrierId    = $projection.AirlineID
  ...
  association [0..1] to ZDT187v_XX_Airport_Dim    as _AirportFrom on  _AirportFrom.AirportId   = $projection.airportfromid
  association [0..1] to ZDT187v_XX_Airport_Dim    as _AirportTo   on  _AirportTo.AirportId     = $projection.airporttoid
